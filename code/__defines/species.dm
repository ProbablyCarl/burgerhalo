...
#define UNGGOY_ARMOR list(BLADE=AP_DAGGER,BLUNT=AP_DAGGER,PIERCE=AP_DAGGER,LASER=-AP_DAGGER*3,ARCANE=AP_SWORD,HEAT=AP_SWORD,COLD=-AP_SWORD*3,BIO=AP_SWORD,HOLY=-AP_SWORD,DARK=AP_SWORD,ION=INFINITY)
