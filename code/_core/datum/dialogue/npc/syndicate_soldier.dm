...
/dialogue/npc/soldier/second/get_dialogue_options(var/mob/living/advanced/player/P,var/list/known_options)
...
/dialogue/npc/soldier/second/set_topic(var/mob/living/advanced/player/P,var/topic)
