...
/loot/weapon/halo/nade
	...
	loot_table = list(
		/obj/item/grenade/landmine/proximity/explosive/halo = 1
	)
	loot_count = 4
	chance_none = 25

/loot/weapon/halo/rifles
	loot_table_guaranteed = list(
	...
	loot_table = list(
		/obj/item/magazine/halo/srs = 2,
		/obj/item/magazine/halo/srs/incendiary = 1
	)
	loot_count = 6
	chance_none = 25
...
/loot/weapon/halo/heavy
	...
	loot_table = list(
		/obj/item/magazine/halo/srs/ap = 2,
		/obj/item/magazine/halo/srs/incendiary = 1
	)
	loot_count = 4
	chance_none = 25