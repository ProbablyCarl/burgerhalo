...
/obj/item/announcement/
	...
	desc = "One day while..."
	desc_extended = "A announcement system."
...
/obj/item/announcement/syndicate
	desc_extended = "A announcement system that sends a taunt to the crew. This one is for URF. Automatically signs your name in the message."
	icon_state = "syndicate"
	title = "Declaration of War"
	sender = "The URF forces"
	value = 500
